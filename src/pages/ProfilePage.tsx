      ...
      <div className="container">
        <div className="row">
          <div className="col-xs-12 col-md-10 offset-md-1">
            <img alt="profile" src="//i.imgur.com/Qr71crq.jpg" className="user-img" />
            <h4>Eric Simons</h4>
            <p>
        ...
        <div className="col-xs-12 col-md-10 offset-md-1">
          ...
          <div className="article-preview">
            <div className="article-meta">
              <a href=""><img alt="profile" src="//i.imgur.com/Qr71crq.jpg" /></a>
              <div className="info">
          ...
          <div className="article-preview">
            <div className="article-meta">
              <a href=""><img alt="author-profile" src="//i.imgur.com/N4VcUeJ.jpg" /></a>
              <div className="info">
